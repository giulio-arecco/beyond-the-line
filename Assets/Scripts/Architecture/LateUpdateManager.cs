    ...
    public class LateUpdateManager : PersistentSingleton<LateUpdateManager> {
        ...
        public void LateUpdate() {
            if(_hasPendingObservers) {
                ...
                _observers.Sort((a, b) => b.LateUpdatePriority.CompareTo(a.LateUpdatePriority));
            }
        ...
        /// <summary>
        /// Registers a script implementing the ILateUpdateObserver interface to the LateUpdateManager's queue.
        /// It's advised calling this method in the OnEnable method of the script implementing the ILateUpdateObserver interface.
        /// </summary>
        /// <param name="observer"> The observer to be registered </param>
        public void Register(ILateUpdateObserver observer) {
            _pendingObservers.Add(observer);
            _hasPendingObservers = true;
        }

        /// <summary>
        /// Unregisters a script implementing the ILateUpdateObserver interface from the LateUpdateManager's queue.
        /// It's advised calling this method in the OnDisable method of the script implementing the ILateUpdateObserver interface.
        /// </summary>
        /// <param name="observer"> The observer to be unregistered </param>
        public bool Unregister(ILateUpdateObserver observer) {
