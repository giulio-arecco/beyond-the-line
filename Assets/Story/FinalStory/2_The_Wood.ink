...
~ CPS_Fatigue_Wood_Entry = GetGlobalStat("Fatigue")

Gli alberi sono spettri alti e contorti, le cui fronde nascondono quel poco di luce lunare che riesce a bucare le nuvole. <nl><>
Il terreno è infido. Radici sporgenti e buche scavate dalle piogge rendono ogni passo una scommessa.

{ HasCompanion("Elias"):
    La nebbia si alza dal sottobosco, fredda, avvolgendovi le caviglie. <nl><>
...
- else:
    La nebbia si alza dal sottobosco, fredda, avvolgendoti le caviglie. <nl><>
...
Un *clic* metallico. Secco. Viene da sotto il tuo stivale destro.
...
Il terrore ti chiude la gola. L'istinto primordiale di fuga prende il sopravvento sulla logica. <nl><>
...
Respiri a fondo, forzando l'aria nei polmoni. Ordini ai tuoi muscoli di diventare pietra. <nl><>
Abbassi lo sguardo, millimetro dopo millimetro. Sotto la suola, parzialmente coperto dal muschio e dalle foglie marce, c'è un disco di metallo arrugginito.
...
=== mine_analysis_logic ===
La luce della luna filtra appena, ma basta per vedere i marchi stampigliati sul metallo. <nl><>
Non sono simboli stranieri.

Riconosci il numero di serie. Riconosci la fattura. È una mina antiuomo M-14. 

È una delle vostre.

Un'amara ironia ti torce lo stomaco. Il comando aveva parlato di campi minati tattici per coprire la ritirata, in caso la battaglia fosse finita male. Non pensavi che saresti stato tu a testarne l'efficacia. La trappola che doveva uccidere il nemico ora tiene in ostaggio te.

{ HasCompanion("Elias"):
    Elias si inginocchia a distanza di sicurezza, studiando l'ordigno. I suoi occhi scorrono sui dettagli tecnici. <nl><>
...
=== lira_appearance ===
Un fascio di luce bianca, accecante, ti investe il viso. Socchiudi gli occhi, cercando di vedere oltre l'abbaglio. <nl><>
Dalle ombre emerge una figura.

Indossa l'uniforme grigio-verde.

Ma c'è qualcosa che non quadra. Non si muove come una pattuglia ed è sola. Procede bassa, silenziosa, sfruttando ogni copertura come un predatore o un ladro. <nl><>
...
{ HasCompanion("Elias"):
    ...
    Elias si irrigidisce al tuo fianco. Dice qualcosa nella loro lingua, una frase secca, quasi un ordine o un saluto formale. Lei lo guarda, poi risponde nella stessa lingua aspra. Ma la sua pronuncia è... sbagliata. Le vocali sono troppo aperte, l'accento è marcato, stridente. <nl><>
    ...
    Lei ignora la confusione di Elias e sposta l'arma su di te, visibilmente agitata dalla presenza di un secondo uomo. <nl><>
    "Krazt!" abbaia.
- else:
    ...
    Ha una pistola in pugno, puntata dritta al tuo petto. La mano è ferma, professionale. <nl><>
    "Krazt!" abbaia un ordine secco nella lingua del nemico.
}

Si avvicina, tenendo l'arma salda in posizione. Il fascio di luce scende sul tuo stivale, illuminando la mina, poi risale sul tuo equipaggiamento. <nl><>
Non chiama rinforzi. Non ti ordina di alzare le mani. <nl><>
"Tori... na krez?" incalza, con un tono impaziente.
...
Sposta il dito sulla guardia del grilletto. Il suo tono cambia istantaneamente, abbandonando i suoni gutturali per un accento pulito, perfettamente comprensibile. <nl><>
"Ascolta bene" dice freddamente. "Sei su una piastra a pressione. Se ti muovi, diventi carne macinata".

I suoi occhi non cercano gradi o mostrine. Cercano zaini e tasche gonfie. <nl><>
...
=== lira_pragmatic ===
Ignori la pistola. Vai dritto al punto: "Se volevi un cadavere, ti bastava aspettare che la mia gamba cedesse. Se sono ancora intero, è perché vuoi qualcosa". <nl><>
...
=== lira_threat ===
Indurisci la mascella. Non sei nella posizione di dare ordini, ma puoi usare l'unica arma che ti resta: la tua stessa morte. <nl><>
"Se spari, o se io mollo la presa, questo ordigno ci cancella entrambi. Non credere di essere al sicuro a quella distanza".

Lei ride. Una risata secca, priva di gioia. <nl><>
"Una minaccia?" <nl><>
Fa un passo indietro, quasi impercettibile. Ha calcolato il raggio dell'esplosione e sa che hai ragione. <nl><>
...
=== lira_negotiation_hub ===
{ lira_patience <= 0:
    Lei stringe la presa sull'arma, spazientita. <nl><>
    "Hai finito di fissarmi? La mia pazienza è finita. Dammi la tua roba se non vuoi saltare in aria".
    -> forced_choice_menu
}

{ lira_negotiation_hub == 1:
    Lei si accuccia parzialmente, mantenendo la distanza e l'arma puntata. <nl><>
    ...
    Si avvicina di un passo, sicura. <nl><>
    ...
    Lei lancia un'occhiata nervosa a Elias, poi torna su di te, il dito che freme sul grilletto. "Non ho tempo per i vostri giochi. Scegli. Ora". <nl><>
...
Sposti lo sguardo verso il basso, fingendo di controllare la mina. I suoi stivali sono coperti di fango, ma la forma è inconfondibile. <nl><>
Non sono gli stivali di cuoio grezzo, a punta tonda, della fanteria nemica. Hanno una suola Vibram rinforzata e un sistema di allacciatura rapida a ganci incrociati. <nl><>
...
La torcia illumina il suo collo per un istante. Sotto il colletto rigido della giacca grigio-verde, intravedi il luccichio dell'argento. Una catenina sottile, con un piccolo pendente lavorato. <nl><>
...
Osservi come si muove. Nonostante il fango e la stanchezza, c'è una disciplina rigida nei suoi gesti. <nl><>
...
Mentre aggiusta la presa sull'arma, la manica della giacca scivola per un istante. Al polso porta un orologio scuro, massiccio. Ma ciò che ti colpisce è come lo indossa: il quadrante è girato verso l'interno del polso.

È una disciplina tattica tipica dei vostri incursori: serve a evitare riflessi accidentali e a leggere l'ora mentre si tiene il fucile in puntamento. <nl><>
...
Cerchi di guardare le sue mani mentre gesticola. Sono sporche di terra e grasso per armi. Le unghie sono tagliate corte, pratiche. C'è sporcizia sotto di esse. Il fango nasconde molto e tre giorni di fuga nel bosco basterebbero a rovinare le mani di chiunque, persino di un ufficiale di alto rango. 
...
Ripensi al momento in cui ha abbandonato la lingua nemica. Non c'è stata l'esitazione di chi deve tradurre mentalmente. Il passaggio è stato immediato, fluido, istintivo. <nl><>
...
Lei si blocca, la mano a mezz'aria sulla mina. Ti guarda con un misto di scherno e curiosità. <nl><>
...
Silenzio. Il bosco sembra trattenere il respiro. <nl><>
...
=== lira_admits ===
~ CPS_Lira_Unmasked_Success = true

Lei rimane immobile per un lungo istante, poi le sue spalle si rilassano. Sorride. Un sorriso vero, stanco, quasi ammirato. <nl><>
"Osservatore. Molto bene. Hai occhio per i dettagli. Forse troppo".

~ lira_respect = lira_respect + 3 

"Diciamo solo che so riconoscere chi ha ricevuto il mio stesso addestramento" rispondi, sostenendo il suo sguardo. "Anche se indossa una divisa che non gli appartiene". <nl><>
...
Lei annuisce, un singolo gesto secco di approvazione. <nl><>
"Già. Immagino sia difficile nascondere certe abitudini a chi sa dove guardare".

Si accuccia rapidamente. Con un gesto fluido, estrae un fermo di metallo e blocca il meccanismo della mina. <nl><>
"Fatto. Sei libero".

Mentre ti sposti, sentendo il sangue tornare a circolare nella gamba intorpidita, lei si alza e rinfodera la pistola. La maschera del bandito è caduta definitivamente. <nl><>
"Tenente Lira Vane. Servizi Informazioni". <nl><>
Si pulisce le mani sui pantaloni, togliendo il fango che usava per camuffarsi. <nl><>
"La mia copertura è saltata tre giorni fa. Sto cercando di raggiungere il confine, ma è un mattatoio là fuori".

Ti guarda con attenzione, ora che la minaccia immediata è passata. <nl><>
...
{ HasCompanion("Elias"):
    Ti guarda, poi sposta lo sguardo su Elias. I suoi occhi si stringono, freddi. <nl><>
    "E lui?" chiede, indicandolo con un cenno del mento. "Quella è l'uniforme del nemico".
    
    "Credo sia un disertore" spieghi rapidamente. "È con me".
    
    Lira non sembra convinta. Fissa Elias, che sostiene il suo sguardo senza aggressività. <nl><>
...
"Da sola sono veloce, ma i miei ordini sono di riportare le informazioni, non di morire eroicamente. Con qualcuno che ti copre le spalle... le probabilità aumentano". Ti porge la mano. <nl><>
...
Accetti la stretta. La sua mano è ruvida, forte. Hai guadagnato un'alleata preziosa, e forse una guida.

-> end_section_two

=== lira_denies ===
Lei scoppia a ridere. Una risata secca, sprezzante. <nl><>
...
=== trade_with_lira ===
~ CPS_Lira_Traded = true 

Non puoi rischiare. La tua vita vale più di qualche scatoletta e le tue deduzioni potrebbero essere sbagliate. <nl><>
...
{ HasCompanion("Elias"):
    Lei non si muove subito. Punta l'arma dritta alla testa di Elias. <nl><>
    "Tu. Indietro. Faccia a terra, mani sulla nuca". <nl><>
    Aspetta che Elias esegua, controllando ogni suo movimento. Solo quando lui è steso nel fango, immobile, lei si avvicina a te. Si muove restando alle tue spalle, usandoti come scudo tra lei e il tuo compagno.
- else:
...
Si accuccia, rovistando con una mano in una tasca interna della giacca. Ne estrae un pezzo di fil di ferro rigido, leggermente ossidato. Non è un attrezzo professionale, ma le sue dita sanno esattamente cosa fare. <nl><>
"Fermo" ordina.

Infila il filo nel foro del meccanismo di sicurezza della mina. Le serve un attimo per trovare l'angolazione giusta, raspando contro il metallo arrugginito, ma alla fine senti un leggero scatto. Piega il metallo per bloccarlo in posizione. <nl><>
"Fatto. Il percussore è bloccato. Scendi. Molto lentamente".

Sposti il peso, il cuore in gola. Non esplode nulla.

"Lo zaino" ordina lei, indietreggiando subito per rimettervi sotto tiro. "Lascialo a terra, aperto. Poi fai tre passi indietro". <nl><>
...
{ HasItem("Ration") || HasItem("Bandages"):
    { HasItem("Ration") && HasItem("Bandages"):
        Le sue dita si chiudono sulla scatola di razioni, poi afferrano rapidamente anche il rotolo di bende. <nl><>
        "Cibo e forniture mediche. Giornata fortunata". <nl><>
    ...
    - else:
        { HasItem("Ration"):
            Le sue dita si chiudono su una scatola di razioni. Un lampo di sollievo le attraversa gli occhi mentre la sfila rapidamente e se la infila in tasca. <nl><>
            "Bene. Questo copre il servizio".
            ~ lira_took_something = true
            ~ RemoveItemFromInventory("Ration", 1)
        - else:
            Le sue dita trovano il rotolo di bende. Esita un istante, sperando in altro, poi lo afferra. <nl><>
            "Mi farò bastare queste". <nl><>
...
- else:
    { HasItem("Crowbar"):
        La sua mano tocca il metallo freddo del piede di porco. Lo tira fuori per un attimo, lo soppesa con disgusto e lo lascia ricadere nel fango con un rumore sordo. <nl><>
        "Ferro vecchio? Credevo di aver chiesto provviste, non una zavorra". <nl><>
        Ti guarda con disprezzo.
    - else:
        Rovista per un attimo, trovando solo il fondo vuoto. <nl><>
        "Vuoto" sibila tra i denti. "Mi hai fatto perdere tempo per un sacco di niente". <nl><>
...
~ CPS_Lira_Respect = lira_respect
~ CPS_Lira_Patience = lira_patience
~ CPS_Lira_Clues_Found_Count = clues_found
~ CPS_Lira_Accusation_Strength = accusation_strength

La tensione cala, lasciando il posto a una stanchezza profonda. Davanti a te, il bosco inizia a diradarsi. <nl><>
Il cielo a est si tinge di un grigio perla sporco. L'alba sta arrivando, e con essa il vento porta un nuovo odore. Non più terra bagnata e pini, ma qualcosa di acre, pungente. <nl><>
