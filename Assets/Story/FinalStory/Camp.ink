...
~ temp current_location_name = ""
{
    - COMPLETED_FARMSTEAD and not COMPLETED_WOOD: 
        ~ current_location_name = "After Farmstead"
        
    - COMPLETED_WOOD and not COMPLETED_VILLAGE:
        ~ current_location_name = "After Wood"
        
    - COMPLETED_VILLAGE and not COMPLETED_ROAD and not COMPLETED_MOUNTAINPASS:
        ~ current_location_name = "After Village"
        
    - COMPLETED_ROAD and not COMPLETED_BORDER:
        ~ current_location_name = "After Military Road"
        
    - COMPLETED_MOUNTAINPASS and not COMPLETED_BORDER:
        ~ current_location_name = "After Mountain Pass"
    - else:
